...
typedef enum
{
  ...
  ESP8266_CMD_ID_EXE_RESTORE_DEF        = (8),
  ESP8266_CMD_ID_GET_WIFI_MODE          = (9),
  ESP8266_CMD_ID_SET_WIFI_MODE          = (10),
  ESP8266_CMD_ID_GET_WIFI_STATE         = (11),
  ESP8266_CMD_ID_GET_WIFI_CONNECTED_AP  = (12),
  ESP8266_CMD_ID_SET_WIFI_CONNECT_AP    = (12),
  ESP8266_CMD_ID_EXE_WIFI_RECONNECT_AP  = (13),
  ESP8266_CMD_ID_GET_WIFI_CONNECTED_AP  = (14),
#ifdef USE_ALL_CMDS
  ...
  ESP8266_CMD_ID_GET_AT_ERR_CODE_PROMPT = (27),
  ESP8266_CMD_ID_EN_AT_ERR_CODE_PROMPT  = (28),
  ESP8266_CMD_ID_DIS_AT_ERR_CODE_PROMPT = (29),
  ESP8266_CMD_ID_SET_WAKEUP_CFG         = (30),
  ESP8266_CMD_ID_GET_PARAM_STORE_MODE   = (31),
  ESP8266_CMD_ID_SET_PARAM_NOT_STORED   = (32),
  ESP8266_CMD_ID_SET_PARAM_STORED_FLS   = (33),
  ESP8266_CMD_ID_SET_READ_REGISTER      = (34),
  ESP8266_CMD_ID_SET_WRITE_REGISTER     = (35),
#endif
} ESP8266_CMD_ID;
