...
ESP8266_AtCmdTable_t EspAtCmdTable[] =
{
  ...
  { ESP8266_CMD_ID_SET_UART_CFG_PERM,   "AT+UART_DEF=\r\n",       NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_GET_SLEEP_CFG,       "AT+SLEEP?\r\n",          NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_SET_SLEEP_CFG,       "AT+SLEEP=\r\n",          NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_QUERY_RAM,           "AT+SYSRAM?\r\n",         NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_GET_SYS_PROMPT_CFG,  "AT+SYSMSG?\r\n",         NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_SET_SYS_PROMPT_CFG,  "AT+SYSMSG=\r\n",         NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_GET_USER_FREE_RAM,   "AT+USERRAM?\r\n",        NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_SET_USER_FREE_RAM,   "AT+USERRAM=\r\n",        NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
  { ESP8266_CMD_ID_GET_USER_PARTITION,  "AT+SYSFLASH?\r\n",       NULL,                "OK",            NULL,          "ERROR",  NULL,   1000u,   NULL },
